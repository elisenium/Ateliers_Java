...
public class TestCompteurEtPositionCompletableFuture {
    ...
    public static void main(String[] args) {
        ...
        //  1. Exécuter tous les compteurs et déterminer la positon de manière asynchrone
        //  en faisant appel à la méthode countAndGetPositionAsync

        futures = Arrays.stream(compteurs).map(compteur ->
                compteur.countAndGetPositionAsync().thenAccept(position ->
                        System.out.println("Compteur : " + compteur.getNom() + " - Position : " + position)
                )
        ...
        //  2. Exécuter tous les compteurs et déterminer la position de manière asynchrone
