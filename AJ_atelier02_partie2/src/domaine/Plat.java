...
public class Plat {
    ...
    private Map<Ingredient, IngredientQuantifie> ingredients = new HashMap<Ingredient, IngredientQuantifie>();
    private Type type;
    ...
    public boolean supprimerIngredient(Ingredient ingredient){
        IngredientQuantifie ingredientQuantifie = trouverIngredientQuantifie(ingredient);
        if (ingredientQuantifie == null) return false;
        return ingredients.remove(ingredient, ingredientQuantifie);
    }
